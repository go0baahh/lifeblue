				...
				<div class="col-lg-6 contact_col">
					<div class="estate_contact_form">
						...
						<div class="estate_contact_form_container">
							...
							<form id="AcquisitionForm" class="estate_contact_form" method="POST" action="app/Controller/ContactForm.Controller.php">
								<input id="name" name="name" class="estate_input_field estate_contact_form_name" type="text" placeholder="Name" required>
								<input id="email" name="email" class="estate_input_field estate_contact_form_email" type="email" placeholder="E-mail" required>
								<input id="address" name="address" class="estate_input_field" type="text" placeholder="Address" required>
                                <input id="phone" name="phone" class="estate_input_field" type="text" placeholder="Phone number" required>
                                <input id="acquisition_method" name="acquisition_method" class="estate_input_field" type="text" placeholder="How did you hear about us?" required>
                                <input id="budget" name="budget" class="estate_input_field" type="number" placeholder="Budget" required>

                                <div class="g-recaptcha" data-sitekey="6LdjMnEUAAAAABWY5b_6TT5iP2vISszhRqyVYDXq"></div>
